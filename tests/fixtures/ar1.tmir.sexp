((functions_block ()) (input_vars ((K <opaque> SInt) (rho <opaque> SReal)))
 (prepare_data
  (((pattern
   ...
   ((pattern
    ...
    (meta <opaque>))
   ((pattern
     (Decl (decl_adtype DataOnly) (decl_id sigma_e) (decl_type (Sized SReal))
      (initialize Default)))
    (meta <opaque>))
   ((pattern
     (Assignment ((LVariable sigma_e) ()) UReal
      ((pattern
 ...
 (prog_name ar1_model) (prog_path tests/fixtures/ar1.stan))