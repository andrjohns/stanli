// Code generated by stanc ac69570
#include <stan/model/model_header.hpp>
namespace es_model_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 16> locations_array__ =
  {" (found before start of program)",
  " (in 'tests/fixtures/es.stan', line 7, column 2 to column 10)",
  " (in 'tests/fixtures/es.stan', line 8, column 2 to column 20)",
  " (in 'tests/fixtures/es.stan', line 9, column 2 to column 24)",
  " (in 'tests/fixtures/es.stan', line 12, column 2 to column 43)",
  " (in 'tests/fixtures/es.stan', line 15, column 2 to column 20)",
  " (in 'tests/fixtures/es.stan', line 16, column 2 to column 21)",
  " (in 'tests/fixtures/es.stan', line 17, column 2 to column 29)",
  " (in 'tests/fixtures/es.stan', line 18, column 2 to column 27)",
  " (in 'tests/fixtures/es.stan', line 2, column 2 to column 17)",
  " (in 'tests/fixtures/es.stan', line 3, column 9 to column 10)",
  " (in 'tests/fixtures/es.stan', line 3, column 2 to column 14)",
  " (in 'tests/fixtures/es.stan', line 4, column 18 to column 19)",
  " (in 'tests/fixtures/es.stan', line 4, column 2 to column 27)",
  " (in 'tests/fixtures/es.stan', line 9, column 9 to column 10)",
  " (in 'tests/fixtures/es.stan', line 12, column 9 to column 10)"};
class es_model final : public model_base_crtp<es_model> {
 ...
 public:
  ~es_model() {}
  es_model(stan::io::var_context& context__, unsigned int random_seed__ = 0,
    ...
    // suppress unused var warning
    (void) base_rng__;
    static constexpr const char* function__ = "es_model_namespace::es_model";
    // suppress unused var warning
    (void) function__;
  ...
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 ac69570",
             "stancflags = --debug-transformed-mir"};
  }
  // Base log prob
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    // suppress unused var warning
    (void) DUMMY_VAR__;
    static constexpr const char* function__ = "es_model_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "es_model_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      current_statement__ = 1;
...
using stan_model = es_model_namespace::es_model;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return es_model_namespace::profiles__;
}
#endif