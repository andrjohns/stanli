((functions_block ())
 ...
 (prepare_data
  (((pattern
   ...
   ((pattern
    ...
    (meta <opaque>))
   ((pattern
     (Decl (decl_adtype DataOnly) (decl_id ys)
      (decl_type
       (Sized
        (SArray SInt
         ((pattern (Lit Int 3)) (meta ((type_ UInt) (loc <opaque>) (adlevel DataOnly)))))))
    ...
    (meta <opaque>))
   ((pattern
     (Assignment ((LVariable ys) ()) (UArray UInt)
      ((pattern
        (FunApp (CompilerInternal FnReadData)
         (((pattern (Lit Str ys))
           (meta ((type_ (UArray UInt)) (loc <opaque>) (adlevel DataOnly)))))))
   ...
   ((pattern
     (Block
      (((pattern
         (TargetPE
          ((pattern
            (FunApp (StanLib categorical_lpmf (FnLpmf false) AoS)
 ...
 (prog_name cat_model) (prog_path tests/fixtures/cat.stan))
