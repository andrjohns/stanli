...
transformed parameters {
  ...
  // compute penalized spline coefficients
  s_1_2 = sds_1[2] * zs_1_2;
  // compute penalized spline coefficients
  s_1_3 = sds_1[3] * zs_1_3;
  // compute penalized spline coefficients
  s_2_1 = sds_2[1] * zs_2_1;
  // compute penalized spline coefficients
  s_2_2 = sds_2[2] * zs_2_2;
  // compute penalized spline coefficients
  s_2_3 = sds_2[3] * zs_2_3;
...
model {
  ...
  if (!prior_only) {
    ...
    mu += Intercept + Xs * bs + Zs_1_1 * s_1_1 + Zs_1_2 * s_1_2 + Zs_1_3 * s_1_3 + Zs_2_1 * s_2_1 + Zs_2_2 * s_2_2 + Zs_2_3 * s_2_3;
