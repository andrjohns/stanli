...
| `election88_full` | 91 | 0 (bitwise) | 0 |
| `garch11` | 5 | 0 (bitwise) | 0 |
...
| `radon_county_intercept` | 389 | 6.3e-15 | 38 |
| `radon_hierarchical_intercept_centered` | 392 | 1.8e-15 | 11 |
