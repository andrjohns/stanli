...
- 194 models at 3 deterministic unconstrained points each, 582 points in
  total, holding 351,652 log-density and gradient values. The models are
  119 posteriordb models that evaluate, 11 language fixtures adapted
  from stanc3's compiler tests, and 64 models generated by brms 2.23.0.
...
- 179 models carry at least one complete row from Stan's per-draw output
  routine, `write_array`, at the same points: 536 rows and 619,382 values
